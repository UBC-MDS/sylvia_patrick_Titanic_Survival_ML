...
As an exploratory analysis, we plotted each feature according to the passenger's survival status. This allows us to gain a sense of the differential distribution of features depending on the passenger's survival.  
