...
# Unit testing
test_df = pd.DataFrame({'Age': [1, 2, 3, 4, 5, 4], 'Fare': [2, 3, 4, 5, 7, 21]})
assert split_data(test_df) == {"Age": np.mean(test_df.Age), "Fare": np.median(test_df.Fare)}, 'The Age or Fare is incorrect.'
